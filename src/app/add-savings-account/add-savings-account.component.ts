...
export class AddSavingsAccountComponent implements OnInit {
  error: any;
  errormes: any;
  ...
  addSavings(data: any) {
    ...
    this.info.AssignAccountPayLoad(this.savings);
    ...
    if (this.savings.accountType === "saving") {
      ...
      this.info.AddCustomer(this.AddPayload).subscribe((response) => {
